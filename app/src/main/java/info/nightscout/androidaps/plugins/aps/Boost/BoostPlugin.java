...
@Singleton
public class BoostPlugin extends PluginBase implements APSInterface, ConstraintsInterface {
    ...
    // last values
    DetermineBasalAdapterBoostJS lastDetermineBasalAdapterBoostJS = null;
    long lastAPSRun = 0;
    DetermineBasalResultBoost lastAPSResult = null;
    ...
    public BoostPlugin(
        ...
        super(new PluginDescription()
                        ...
                        .fragmentClass(BoostFragment.class.getName())
                        .pluginIcon(R.drawable.ic_generic_icon)
                        .pluginName(R.string.Boost)
                        .shortName(R.string.Boost)
    ...
    public void invoke(String initiator, boolean tempBasalFallback) {
        ...
        lastAPSResult = null;
        DetermineBasalAdapterBoostJS determineBasalAdapterBoostJS;
        determineBasalAdapterBoostJS = new DetermineBasalAdapterBoostJS(new ScriptReader(context), getInjector());
        ...
        IobTotal[] iobArray = iobCobCalculatorPlugin.calculateIobArrayForSMB(lastAutosensResult, BoostDefaults.exercise_mode, BoostDefaults.half_basal_exercise_target, isTempTarget);
        ...
        try {
            determineBasalAdapterBoostJS.setData(profile, maxIob, maxBasal, minBg, maxBg, targetBg, activePlugin.getActivePump().getBaseBasalRate(), iobArray, glucoseStatus, mealData,
        ...
        DetermineBasalResultBoost determineBasalResultBoost = determineBasalAdapterBoostJS.invoke();
        ...
        if (determineBasalResultBoost == null) {
            ...
            if (determineBasalResultBoost.rate == 0d && determineBasalResultBoost.duration == 0 && !treatmentsPlugin.isTempBasalInProgress())
                determineBasalResultBoost.tempBasalRequested = false;
