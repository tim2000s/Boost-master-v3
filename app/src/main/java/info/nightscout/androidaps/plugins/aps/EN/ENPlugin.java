...
@Singleton
public class ENPlugin extends PluginBase implements APSInterface, ConstraintsInterface {
    ...
    // last values
    DetermineBasalAdapterENJS lastDetermineBasalAdapterENJS = null;
    long lastAPSRun = 0;
    DetermineBasalResultEN lastAPSResult = null;
    ...
    public ENPlugin(
        ...
        super(new PluginDescription()
                        ...
                        .fragmentClass(ENFragment.class.getName())
    ...
    public void invoke(String initiator, boolean tempBasalFallback) {
        ...
        lastAPSResult = null;
        DetermineBasalAdapterENJS determineBasalAdapterENJS;
        determineBasalAdapterENJS = new DetermineBasalAdapterENJS(new ScriptReader(context), getInjector());
        ...
        try {
            determineBasalAdapterENJS.setData(profile, maxIob, maxBasal, minBg, maxBg, targetBg, activePlugin.getActivePump().getBaseBasalRate(), iobArray, glucoseStatus, mealData,
        ...
        DetermineBasalResultEN determineBasalResultEN = determineBasalAdapterENJS.invoke();
        ...
        if (determineBasalResultEN == null) {
            ...
            if (determineBasalResultEN.rate == 0d && determineBasalResultEN.duration == 0 && !treatmentsPlugin.isTempBasalInProgress())
                determineBasalResultEN.tempBasalRequested = false;
