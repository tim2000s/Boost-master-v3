...
class DetermineBasalAdapterENJS internal constructor(private val scriptReader: ScriptReader, private val injector: HasAndroidInjector) {
    ...
    @Suppress("SpellCheckingInspection") fun setData(profile: Profile,
        ...
        this.profile.put("min_bg", Math.round(minBg))
        this.profile.put("max_bg", Math.round(maxBg))
        this.profile.put("target_bg", Math.round(targetBg))
...
//**********************************************************************************************************************************************
        // patches ==== START
        this.profile.put("normal_target_bg", Math.round(profile.getTargetMgdl()))

        this.profile.put("enableGhostCOB", sp.getBoolean(R.string.key_use_ghostcob, false))
        this.profile.put("COBBoostWindow", sp.getInt(R.string.key_eatingnow_cobboostminutes, 15))
        ...
        this.profile.put("UAMBoost_SMBScale", sp.getDouble(R.string.key_eatingnow_uamboost_smbscale, 1.0))
        ...
        this.profile.put("ISFBoost_SMBScale", sp.getDouble(R.string.key_eatingnow_isfboost_smbscale, 1.0))
