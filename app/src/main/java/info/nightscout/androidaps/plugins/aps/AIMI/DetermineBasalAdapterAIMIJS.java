...
public class DetermineBasalAdapterAIMIJS {
    ...
    public void setData(Profile profile,
        ...
        mMealData.put("currentTIRLow",StatTIR.averageTIR(StatTIR.calculateDaily(80,180)).belowPct());
        mMealData.put("currentTIRRange",StatTIR.averageTIR(StatTIR.calculateDaily(80,180)).inRangePct());
        mMealData.put("currentTIRAbove",StatTIR.averageTIR(StatTIR.calculateDaily(80,180)).abovePct());
