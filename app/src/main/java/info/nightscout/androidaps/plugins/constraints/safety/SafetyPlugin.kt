...
class SafetyPlugin @Inject constructor(
    ...
    override fun applyMaxIOBConstraints(maxIob: Constraint<Double>): Constraint<Double> {
        ...
        val maxIobPref: Double = if (openAPSSMBPlugin.isEnabled() || BoostPlugin.isEnabled() || openAPSSMBDynamicISFPlugin.isEnabled() || tsunamiPlugin.isEnabled()) sp.getDouble(R.string.key_openapssmb_max_iob, 3.0) else sp.getDouble(R.string.key_openapsma_max_iob, 1.5)
