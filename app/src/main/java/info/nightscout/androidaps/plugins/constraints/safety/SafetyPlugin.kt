...
class SafetyPlugin @Inject constructor(
    ...
    override fun applyMaxIOBConstraints(maxIob: Constraint<Double>): Constraint<Double> {
        ...
        if (fullUAMPlugin.isEnabled(PluginType.APS)) maxIob.setIfSmaller(aapsLogger, hardLimits.maxIobFullUAM(), String.format(resourceHelper.gs(R.string.limitingiob), hardLimits.maxIobSMB(), resourceHelper.gs(R.string.hardlimit)), this)
