...
//        double normal_target_bg = profile.getTargetMgdl(Profile.secondsFromMidnight(mCurrentTime));
        ...
        mMealData.put("firstBolusCorrTime",treatmentsPlugin.getFirstENBolusTime(sp.getInt(R.string.key_eatingnow_timestart, 9)));
        ...
        //int lowMgdl = (int) Math.min(normal_target_bg-27,72); // minimum 72 = 4.0
        //int highMgdl = (int) (normal_target_bg+45);
        int lowMgdl = 72, highMgdl = 153; // 4.0 - 8.5mmol
