...
//                    if (profile.temptargetSet && profile.temptarget_minutesrunning <= 45) UAMBoostOK = true;
                ...
                if (UAMBoostOK && UAMBoost > UAMBoost_threshold) {
                    ...
                    // 65% insulinReqPct with a temp target that has a prebolus
                    insulinReqPct = (profile.temptargetSet && profile.temptarget_duration > 60 ? insulinReqPctDefault : insulinReqPct);
