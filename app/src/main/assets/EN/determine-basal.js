    ...
    if (iob_data.iob > max_iob) {
        ...
        if (microBolusAllowed && enableSMB && bg > threshold) {
            ...
            if (eatingnow && eventualBG > normalTarget) {
                ...
                // ============== INSULIN BOOST  ==============
                UAMBoostReason =  "UAM" + (UAMBoostMAX ? "-MAX" : "");
                UAMBoostReason += (UAMBoosted && UAMBoost > UAMBoost_threshold ? ">" + round(UAMBoost_threshold,1) : "");
                UAMBoostReason += "=" + UAMBoost + (UAMBoosted ? "*" + round(UAMBoost_bolus,2)+ "*" + UAMBoost_bolus_scale :"") + UAMBoostReason;
