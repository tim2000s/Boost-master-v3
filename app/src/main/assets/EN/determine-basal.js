...
//        var BolusedEN = round((new Date().setHours(profile.EatingNowTimeStart) - meal_data.lastBolusCorr )/60000,0);
        var BolusedEN = new Date(systemTime).getTime().setHours(profile.EatingNowTimeStart);
...
//                var BGBoost_bolus = profile.EatingNowBGBoostBolus;
                ...
                // set UAMBoost Bolus
                var UAMBoost_bolus = profile.EN_UAMBoostBolus;
...
//                }
                ...
                if (UAMBoostOK && UAMBoost > UAMBoost_threshold) {
                    ...
                    // set max SMB for UAMBoost no TT
