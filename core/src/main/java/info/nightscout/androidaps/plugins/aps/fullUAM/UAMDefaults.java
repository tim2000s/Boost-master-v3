...
public class UAMDefaults {
    ...
    public final static boolean low_temptarget_lowers_sensitivity = true; // lower sensitivity for
    // temptargets <= 99.
    public final static boolean high_temptarget_raises_sensitivity = true; // raise sensitivity
    // for temptargets >= 111.  synonym for exercise_mode
    public final static boolean sensitivity_raises_target = true; // raise BG target when autosens
    // detects sensitivity
    public final static boolean resistance_lowers_target = true; // lower BG target when autosens
    // detects resistance
    public final static boolean adv_target_adjustments = true; // lower target automatically when BG
    // and eventualBG are high
    public final static boolean exercise_mode = true; // when true, > 105 mg/dL high temp target
    // adjusts sensitivityRatio for exercise_mode. This majorly changes the behavior of high temp targets from before. synonmym for high_temptarget_raises_sensitivity
