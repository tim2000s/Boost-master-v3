...
public class UAMDefaults {
    ...
    public final static boolean low_temptarget_lowers_sensitivity = false; // lower sensitivity for
    // temptargets <= 99.
    public final static boolean high_temptarget_raises_sensitivity = false; // raise sensitivity
    ...
    public final static boolean adv_target_adjustments = false; // lower target automatically when BG
    // and eventualBG are high
    public final static boolean exercise_mode = false; // when true, > 105 mg/dL high temp target
